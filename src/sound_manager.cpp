...
Sound SoundManager::CreateProceduralSound(SoundID id) {
    // Create simple procedural sounds as fallbacks
    Wave wave;
    ...
    switch (id) {
        ...
        case SND_RIFLE_SHOT:
            // Sharp bang sound
            wave = GenWaveSquare(0.1f, 220.0f);
            break;
            
        case SND_RELOAD:
            // Mechanical click
            wave = GenWaveSquare(0.2f, 440.0f);
            break;
            
        case SND_EMPTY_CLICK:
            // Short click
            wave = GenWaveSquare(0.05f, 880.0f);
            break;
            
        case SND_ITEM_PICKUP:
        case SND_ITEM_USE:
            // Pleasant chime
            wave = GenWaveSine(0.15f, 660.0f);
            break;
        ...
        case SND_FOOTSTEP_METAL:
            // Dull thud
            wave = GenWaveSquare(0.1f, 110.0f);
            break;
            
        case SND_DOOR_OPEN:
        case SND_DOOR_CLOSE:
            // Creaking sound
            wave = GenWaveSquare(0.3f, 220.0f);
            break;
            
        case SND_FLASHLIGHT_TOGGLE:
            // Click
            wave = GenWaveSquare(0.05f, 440.0f);
            break;
            
        case SND_UI_SELECT:
            // Positive beep
            wave = GenWaveSine(0.1f, 880.0f);
            break;
            
        case SND_UI_BACK:
            // Lower beep
            wave = GenWaveSine(0.1f, 440.0f);
            break;
            
        case SND_UI_ERROR:
            // Buzzer
            wave = GenWaveSquare(0.2f, 110.0f);
            break;
        ...
        case SND_CRAFT_SUCCESS:
            // Success fanfare
            wave = GenWaveSine(0.5f, 880.0f);
            break;
            
        case SND_LOW_HEALTH_HEARTBEAT:
            // Low pulse
            wave = GenWaveSine(0.5f, 60.0f);
            break;
            
        case SND_BREATHING_HEAVY:
            // Breath sound
            wave = GenWaveSquare(1.0f, 220.0f);
            break;
            
        case SND_JUMP:
        case SND_LAND:
            // Whoosh
            wave = GenWaveSine(0.2f, 330.0f);
            break;
